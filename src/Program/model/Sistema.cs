...
namespace PII_E13.model
{
    ...
    public class Sistema
    {
        ...
        /// </summary>
        public void RegistrarEmpresa(int id, string ciudad, string direccion, string rubro, string nombre)
        {
        ...
        /// </summary>
        public void RegistrarEmprendedor(int id, string ciudad, string direccion, string rubro, string nombre,
        ...
        public Emprendedor ObtenerEmprendedorPorId(int id)
        {
