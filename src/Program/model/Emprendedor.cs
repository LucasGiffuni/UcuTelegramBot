...
namespace PII_E13.model
{
    ...
    public class Emprendedor : Person
    {   
        /// <summary>
        ...
        public Emprendedor(int id, string nombre, List<Habilitacion> habilitaciones, string ciudad, string direccion, string rubro): base(id, nombre, "Emprendedor")
        {
            this.Id = id;
            this.Nombre = nombre;
